# UIT_WhiteCow at DSC 2025: Hallucination Detection for Vietnamese Large Language Models via Fine-tuning and Small Model Ensembles

## Overview

The objective of the challenge is to classify the faithfulness of a Vietnamese LLM’s response given a specific context and prompt.  
Each sample in the dataset consists of three components:

**Context (C):**  
A reference passage consisting of 1–3 sentences.

**Prompt (P):**  
A question or instruction. Prompts are categorized into three types:
...
**Response (R):**  
The answer generated by the target LLM.
